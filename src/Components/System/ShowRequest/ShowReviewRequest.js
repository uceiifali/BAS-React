  ...
  return (
    <div className='show-review   p-2'>
        ...
        <div className='row px-2 py-3'>
          ...
          <div className='col-md-3 mb-2'>
            <p className='text-white'>  الحالة  :
              ...
              {ReviewProjectType === "inProgress" ? <span>
                قيد التنفيذ
              </span> : ReviewProjectType === "pending" ? <span>
                فى انتظار الموافقة
              </span> : ReviewProjectType === "rejected" ? <span>
                مرفوضة
              </span> : ""
          ...
          <div className='col-md-4 mb-2'>
            {ReviewProjectType == "inProgress" ?
              ...
              : ReviewProjectType === "pending" ?
                ...
                </div> : ReviewProjectType === "rejected" ?
                  <div className='d-flex gap-3'>
                    <img className='pointer confirm' onClick={() => {
                      setAcceptRequest(true)
      ...
      <fieldset className='border-golden my-4'>
        ...
        <div className='row px-2'>
          <div className='col-md-6 mt-3'>
            <p className='text-white'> رقم الرخصة : <span>BSA</span></p>
          </div>
          <div className='col-md-6 mt-3'>
            <p className='text-white'>
              تاريخ الرخصة
              : <span>     ــــــــــ </span></p>
          </div>
          <div className='col-md-6 mt-3'>
            <p className='text-white'>         سند الرخصة   : <span></span></p>
          </div>
          <div className='col-md-6 mt-3'>
            <p className='text-white'> رقم الرخصة  : <span> </span></p>

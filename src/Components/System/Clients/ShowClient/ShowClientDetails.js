...
const ShowClientDetails = ({ showProject, setShowProject , data }) => {
      ...
      status: (
        <div className="mt-2 flex flex-column justify-content-center align-iems-center gap-1 my-1">
          <svg
            ...
            fill="none"
          >
            <g clipPath="url(#clip0_667_12027)">
              <path
                  ...
                  <div className="row">
                    <div className="col-md-6 mb-3">
                      <p className="text-white">
                        اسم المشروع : <span className="main-text">
                          {data?.projectName}
                        </span>
                      </p>
                    </div>
                    ...
                    <div className="col-md-6 mb-3">
                      <p className="text-white">
                        {" "}
                        موقع المشروع:{" "}
                        <span className="main-text"> {data?.buildingLocation} </span>
                      </p>
                    </div>
                    ...
                    <div className="col-md-6 mb-3">
                      <p className="text-white">
                        {" "}
                        المدينة : <span className="main-text">{data?.city}</span>
                      </p>
                    </div>
                    <div className="col-md-6 mb-3">
                      <p className="text-white">
                        {" "}
                        الحى : <span className="main-text">{data?.area}</span>
                      </p>
                    </div>
                    <div className="col-md-6 mb-3">
                      <p className="text-white">
                        {" "}
                        رقم المخطط :{" "}
                        <span className="main-text">{data?.chartNumber}</span>
                      </p>
                    </div>
                    <div className="col-md-6 mb-3">
                      <p className="text-white">
                        {" "}
                        رقم القطعه :{" "}
                        <span className="main-text">{data?.pieceNumber}</span>
                      </p>
                    </div>
                    <div className="col-md-12 mb-3">
                      <p className="text-white">
                        {" "}
                        رقم الشهادة الضربية :{" "}
                        <span className="main-text">{data?.taxNumber}</span>
                      </p>
                    </div>
                    <div className="col-md-6 mb-3">
                      <p className="text-white">
                        {" "}
                        الوكيل : <span className="main-text">{data?.agent}</span>
                      </p>
                    </div>
                    <div className="col-md-6 mb-3">
                      <p className="text-white">
                        {" "}
                        رقم الوكالة :{" "}
                        <span className="main-text">{data?.agencyNumber}</span>
                      </p>
                    </div>
                    <div className="col-md-6 mb-3">
                      <p className="text-white">
                    ...
                    <div className="col-md-6 mb-3">
                      <p className="text-white">
                        {" "}
                        رقم الصك :<span className="main-text">{data?.instrumentNumber}</span>
                      </p>
                    </div>
                    <div className="col-md-6 mb-3">
                      <p className="text-white">
                        {" "}
                        تاريخ الأستلام :{" "}
                        <span className="main-text">{convertDateFormat(data?.licenseDate)}</span>
                      </p>
                    </div>
                    <div className="col-md-6 mb-3">
                      <p className="text-white">

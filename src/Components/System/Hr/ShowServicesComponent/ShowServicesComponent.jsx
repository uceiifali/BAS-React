...
const ShowServicesComponent = ({ showServices, setShowServices }) => {
    return (
        <div>
            {showServices &&
                <Modal
                ...
                >
                    ...
                    <Modal.Body className=' p-2'>
                        ...
                        <fieldset className='displayFieldSet my-2    p-3 w-90 mx-auto'>
                            ...
                            <div className='row'>
                                <div className='col-md-12 mb-4'>
                                    <p className='text-white'> نوع النموذج  :
                                        <span className='main-text p-2'>
                                            :  طلب زيادة
                                ...
                                <div className='col-md-4  mb-4'>
                                    <p className='text-white'> التاريخ  :
                            ...
                            <div className='row'>
                                <div className='col-md-12 mb-4'>
                                    ...
                                    <div className='w-[93px] pointer h-[61px]'>
                                        ...
                                        <p className='text-white text-center '>طلب نوظيف</p>
                                    </div>
                        ...
                        <div className='my-3' onClick={() => { setShowServices(false) }}>

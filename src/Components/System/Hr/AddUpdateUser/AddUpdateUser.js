        ...
        <div className='addUpdateUser overflow-y-auto P-4'>
                ...
                >
                    ...
                    <Modal.Body >
                        ...
                        <div className='d-flex w-75 flex-column mx-auto mt-3 justify-content-center align-items-center '>
                            {!id ? <p className='text-white mb-4' style={{ fontSize: "30px" }}>تم اضافة مستخدم جديد بنجاح</p> : <p className='text-white' style={{ fontSize: "30px" }}> تم تعديل بيانات المستخدم بنجاح</p>}
                            <Button type='submit'
                                onClick={() => {
            ...
            <Form onSubmit={handleAddUpdateUser}>
                    ...
                    {id ? <div className='row'>
                        <div className='row '>
                            <div className='col-md-4 mb-2 '>
                                <Input label={" كلمه المرور القديمة"} background='#2B2B40' type='password' {...oldPassword.bind} placeholder=' ادخل كلمة المرور القديمة' />

                            </div>
                            <div className='col-md-4 mb-2 '>
                                <Input label={" كلمه المرور الجديدة"} background='#2B2B40' type='password' {...newPassword.bind} placeholder='ادخل كلمة المرور الجديدة' />

                            </div>
                            <div className='col-md-4 mb-2 '>
                                <Input label={" تاكيد كلمة المرور الجديدة"} type='password'   {...reNewPassword.bind} placeholder="اعد ادخال كلمة المرور " />
                ...
                <fieldset className='golden-square  w-90 p-4 px-4   mt-3 mx-auto' >
                    ...
                    < div className='row'>
                        <div className='col-md-4 col-sm-6 mb-2 d-flex justify-content-center'>
                            <Input label=" المرتب الاساسي " {...baseSalary.bind} placeholder=" ادخل المرتب الاساسي  " />
                        </div>
                        <div className='col-md-4 col-sm-6 mb-2 d-flex justify-content-center'>
                            <Input label=" نسبة الزيادة " {...increaseAmount.bind} placeholder=" ادخل نسبة الزيادة  " />
                        </div>
                        <div className='col-md-4 col-sm-6 mb-2 d-flex justify-content-center'>
                ...
                <fieldset className='golden-square  w-90 p-4 px-4   mt-3 mx-auto' >
                    ...
                    < div className='row'>
                        <div className='col-md-6  mb-2'>
                            <Input label=" المسئول عن التوظيف  " className='w-100' {...baseSalary.bind} placeholder=" اكتب اسم المسوؤل عن التوظيف" />
                        </div>

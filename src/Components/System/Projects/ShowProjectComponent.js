...
const ShowProjectComponent = ({ showProject, setShowProject , data }) => {
  // show img
  ...
  return (
    <div className="showProject">
      ...
      {viewMore && (
        <Modal
          className="viewMore bg-black/50 "
          size="lg"
          aria-labelledby="contained-modal-title-vcenter "
          onHide={() => setViewMore(false)}
          contentClassName="scrollbar-none border !border-[#efaa207f]"
          show={viewMore}
        >
              ...
              <div className="row px-2 py-2">
                <div className="col-md-6 mt-2">
                  <p className="text-white">
                    اسم المالك : <span>{data?.requestId?.ownerName}</span>
                  </p>
                </div>
                <div className="col-md-6 mt-2">
                  <p className="text-white">
                    {" "}
                    موقع المشروع : <span>{data?.requestId?.buildingLocation}</span>
                  </p>
                </div>
                <div className="col-md-6 mt-2">
                  <p className="text-white">
                    {" "}
                    المدينة : <span>{data?.requestId?.city}</span>
                  </p>
                </div>
                <div className="col-md-6 mt-2">
                  <p className="text-white">
                    {" "}
                    الحي : <span>{data?.requestId?.area}</span>
                  </p>
                </div>
                <div className="col-md-6 mt-2">
                  <p className="text-white">
                    {" "}
                    رقم القطعة : <span>{data?.requestId?.pieceNumber}</span>
                  </p>
                </div>
                <div className="col-md-6 mt-2">
                  <p className="text-white">
                    {" "}
                    رقم المخطط : <span>{data?.requestId?.chartNumber}</span>
                  </p>
                </div>
                <div className="col-md-6 mt-2">
                  <p className="text-white">
                    {" "}
                    نوع المشروع : <span>{data?.requestId?.projectType === 1
                                  ? "تصميم"
                                  : data?.requestId?.projectType === 2
                                  ? "اشراف علي التنفيذ"
                                  : null} </span>
                  </p>
                </div>
              ...
              <div className="row px-2 py-2">
                <div className="col-md-6 mt-3">
                  <p className="text-white">
                    {" "}
                    نوع العميل : <span>
                    {data?.requestId?.clientType === 1 ? "حكومي أو مستثمر" 
                : data?.requestId?.clientType === 2 ? "شركة أو مؤسسة" 
                : data?.requestId?.clientType === 3 ? "فردي" 
                : null
                }
                    </span>
                  </p>
                ...
                <div className="col-md-6 mt-3">
                  <p className="text-white">
                    {" "}
                    رقم الشهادة الضربية : <span>{data?.requestId?.taxNumber}</span>
                  </p>
                </div>
                <div className="col-md-6 mt-3">
                  <p className="text-white">
                    {" "}
                    نوع الهوية : <span>
                    {data?.requestId?.identityType === 1
                        ? "هوية"
                        : data?.requestId?.identityType === 2
                        ? "تجاري"
                        : null}
                ...
                <div className="col-md-6 mt-3">
                  <p className="text-white">
                    {" "}
                    البريد الالكتروني : <span> {data?.requestId?.email}</span>
                  </p>
                </div>
                ...
                <div className="col-md-6 mt-3">
                  <p className="text-white">
                    {" "}
                    رقم الجوال : <span> {data?.requestId?.phone} </span>
                  </p>
                </div>
              </div>
            </fieldset>
              ...
              <fieldset className="border-golden my-4">
                ...
                <div className="row px-2 py-2">
                  <div className="col-md-6 mt-3">
                    <p className="text-white">
                      {" "}
                      نوع العميل : <span>{data?.requestId?.clientType === 1 ? "حكومي أو مستثمر" 
                : data?.requestId?.clientType === 2 ? "شركة أو مؤسسة" 
                : data?.requestId?.clientType === 3 ? "فردي" 
                : null
                }</span>
                  ...
                  <div className="col-md-6 mt-3">
                    <p className="text-white">
                      {" "}
                      رقم الوكالة : <span>{data?.requestId?.agencyNumber}</span>
                    </p>
                  </div>
                  <div className="col-md-6 mt-3">
                    <p className="text-white">
                  ...
                  <div className="col-md-6 mt-3">
                    <p className="text-white">
                      {" "}
                      رقم الصك : <span> {data?.instrumentNumber} </span>
                    </p>
                  </div>
                  <div className="col-md-6 mt-3 mb-3">
                    <img
              ...
              <fieldset className="w-full border-golden my-4">
                ...
                <div className="row px-2 py-2">
                  <div className="col-md-6 mt-3">
                    <p className="text-white">
                      {" "}
                      رقم الرخصة : <span>{data?.requestId?.licenseNumber}</span>
                    </p>
                  </div>
                  <div className="col-md-6 mt-3">
                    <p className="text-white">
                      {" "}
                      تاريخ الرخصة : <span>{convertDateFormat(data?.requestId?.licenseDate)}</span>
                    </p>
                  </div>
                  <div className="col-md-6 mt-3">
                    <p className="text-white">
                      {" "}
                      سند الرخصة : <span>{data?.requestId?.licenseDeed}</span>
                    </p>
                  </div>
      ...
      <div className="border-golden">
        <div className="grid grid-cols-12 gap-y-2 p-3">
          ...
          <div className="col-span-8 mb-2">
            <p className="text-white">
              اسم المشروع : <span className="text-white/20">{data?.requestId?.projectName}</span>{" "}
            </p>
          </div>
          ...
          <div className="col-span-8 mb-3">
            <p className="text-white">
              نوع المشروع : <span className="text-white/20">{data?.requestId?.projectType === 1 ? "تصميم" : data?.requestId?.projectType === 2 ? "اشراف علي التنفيذ" : null}</span>{" "}
            </p>
          </div>
          ...
          <div className="col-span-8 mb-2">
            <p className="text-white">
              {" "}
              رقم الطلب : <span className="text-white/20"> {data?.requestId?.orderNumber}</span>{" "}
            </p>
          </div>
      ...
      <div className="overflow-y-scroll scrollbar-none p-3 h-[600px]">
        <fieldset className="showProjectBorder pb-3 ">
          ...
          <div className="d-flex w-90 m-auto justify-content-between">
            <p className="projectdetails text-white">
              {" "}
              اسم المالك :<span className="main-text">{data?.requestId?.ownerName}</span>
            </p>
            <p className="projectdetails text-white">
              {" "}
              نوع المشروع :
              <span className="main-text">{data?.requestId?.projectType === 1 ? "تصميم":data?.requestId?.projectType === 2 ? "اشراف علي التنفيذ" : null}</span>
            </p>
          </div>
          <p className="projectdetails text-white w-90 m-auto">
            {" "}
            موقع المشروع :<span className="main-text"> {data?.requestId?.buildingLocation}</span>
          </p>
        </fieldset>
        <fieldset className="showProjectBorder p-2 ">
          ...
          <p
            ...
            className="form-control my-3 w-100 m-auto h-32"
          

          >
            {data?.requestId?.notes}
          </p>
        </fieldset>
        <fieldset className="showProjectBorder p-2 ">
              ...
              ? ShowProjectsData.map(
                  (
                    ...
                    >
                      ...
                      <TableCell>
                        <div className="cursor-pointer" onClick={() => setOpenClaim(true)}>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="17"
                            height="21"

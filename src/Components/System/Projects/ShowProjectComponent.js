        ...
        <div className='showProject'>
                ...
                >
                    ...
                    <Modal.Body className='d-flex align-items-center'>
                        ...
                        <div className='d-flex w-75 flex-column mx-auto mt-3 justify-content-center align-items-center '>
                            {<p className='text-white' style={{ fontSize: "30px" }}>  هل انت متاكد من تعليق هذا المشروع </p>}
            ...
            >
                ...
                <Modal.Body >
                    ...
                    <div className='w-100   mt-3 '>
                        {<p className='text-white' style={{ fontSize: "30px" }}> اترك سبب التعليق .... </p>}

                        <Form className='w-100'>
                            <textarea className='form-control w-100' rows={5} placeholder='اترك سبب التعليق ....' />
            ...
            >
                ...
                <Modal.Body >
                    ...
                    <div className='d-flex w-75 flex-column mx-auto mt-3 justify-content-center align-items-center '>
                        {<p className='text-white mb-4' style={{ fontSize: "30px" }}>  تم استكمال المشروع   بنجاح  </p>}
                        <Button
                            onClick={() => {
            ...
            {continueProject &&
                ...
                >
                    ...
                    <Modal.Body className='d-flex align-items-center'>
                        ...
                        <div className='d-flex w-75 flex-column mx-auto mt-3 justify-content-center align-items-center '>
                            {<p className='text-white' style={{ fontSize: "30px" }}>  هل انت متاكد من استكمال هذا المشروع </p>}
                            <div className='d-flex justify-content-center mt-3 gap-3'>
                    ...
                    <div className='col-md-4 mb-3'>
                        <p className='text-white'>
                            <p className='text-white'>  الحالة  :
                                ...
                                {ProjectTime === "inProgress" ? <span>
                                    قيد التنفيذ
                                </span> : ProjectTime === "Waiting" ? <span>
                                    مشروع معلق
                                </span> : ProjectTime === "Done" ? <span>
                                    منتهية
                                </span> : ""
                        ...
                        {ProjectTime == "inProgress" ?
                            ...
                            : ProjectTime === "Waiting" ?
                                ...
                                <div className='d-flex gap-3'>
                                    <img className='pointer Continue delete-icon' onClick={() => {
                                    ...
                                    <img className='pointer action-icon' onClick={() => {
                                        // setEditRequest(true)
                                    }} src={process.env.PUBLIC_URL + "/icons/edit.png"} />
                                    <NavDropdown title={<svg xmlns="http://www.w3.org/2000/svg" width="4" height="16" viewBox="0 0 4 16" fill="none">
                                        <path d="M2 16C0.89543 16 0 15.1046 0 14C0 12.8954 0.89543 12 2 12C3.10457 12 4 12.8954 4 14C4 15.1046 3.10457 16 2 16ZM2 10C0.89543 10 0 9.10457 0 8C0 6.89543 0.89543 6 2 6C3.10457 6 4 6.89543 4 8C4 8.53043 3.78929 9.03914 3.41421 9.41421C3.03914 9.78929 2.53043 10 2 10ZM2 4C0.89543 4 0 3.10457 0 2C0 0.89543 0.89543 0 2 0C3.10457 0 4 0.89543 4 2C4 2.53043 3.78929 3.03914 3.41421 3.41421C3.03914 3.78929 2.53043 4 2 4Z" fill="white" />
            ...
            <fieldset className='showProjectBorder pb-3 ' >
                ...
                <div className='d-flex w-90 m-auto justify-content-between'>
                    <p className='projectdetails text-white'> اسم المالك  :
                        <span className='main-text'> سلطان عبد الله
                        </span>
                    </p>
                    <p className='projectdetails text-white'> نوع المشروع   :
                        <span className='main-text'>  الاشراف علي التنفيذ
                        </span>
                    </p>

                </div>
                <p className='projectdetails text-white w-90 m-auto'> موقع  المشروع   :
                    <span className='main-text'> الدمام
                    </span>
                </p>
            ...
            <fieldset className='showProjectBorder p-2 ' >
                ...
                <textarea placeholder='اكتب ملاحظات المشروع  ' className='form-control my-3 w-100 m-auto' cols={30} rows={5} />
            ...
            <fieldset className='showProjectBorder p-2 ' >
                ...
                <div className='w-90 p-3 m-auto d-flex  gap-5'>
                    ...
                    {ProjectTime === "Done" &&
                        <div className='pdfbg'>
                            <img src={process.env.PUBLIC_URL + "/icons/Pdf.png"} alt="pdf" className='pdfImage' />
                            <div style={{ borderRadius: "7px" }} className='bg-[#252538]    d-flex justify-content-center m-auto     '>
                                <p className='text-white   mt-2 '>   الملف النهائي
                                    للمشروع
                                </p>
                            </div>
                        </div>
            ...
            <fieldset className='showProjectBorder p-2 ' >
                ...
                <div className='d-flex mx-2 justify-content-between '>
                    <p className='text-white'>المبلغ الاجمالى : <span className='main-text'> 1000 ريال</span></p>
                    <p className='text-white'> عدد الدفعات :  <span className='main-text'> 2</span></p>

                </div>
                <div className='d-flex mx-2 justify-content-between'>
                    <p className='text-white'> المبلغ المتبقى :     <span className='main-text'> 0ريال  </span></p>
                    <p className='text-white'> عدد الدفعات المتبقى : <span className='main-text'> 0</span></p>

                </div>
                <DataTableComponent className={"my-2 overflow-x-hidden overflow-y-auto"} columns={columns} data={ShowProjectsData} />

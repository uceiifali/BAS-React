...
const AddUpdateDesignReport = ({ id = null, setId, setEditReport }) => {
  ...
  const {
    ...
    defaultValues: {
      ...
      areaGroup: [{ component: "", rolesDueTolisence: "", usage: "", lisence: "", lisenceUnitesNumber: "", nature: "", natureUnitesNumber: "", difference: "", areaNotes: "" }]
    },
  ...
  return (
    <div className="AddDesignReport  p-3">
      {
        id ? <p className="text-xl text-[#EFAA20] ">
          تعديل التقرير
        </p> :
                ...
                <div className="col-md-4 d-flex align-items-center mb-4">
                  <div className="input-container">
                    ...
                    <Form.Group>
                      ...
                      <input className="form-control "   {...register("iDNumber")} />
                ...
                <div className="col-md-4 d-flex align-items-center mb-4">
                  <div className="input-container">
                    ...
                    <Form.Group>
                      ...
                      <input className="form-control "   {...register("OrganizationalChart")} />
                ...
                <div className="col-md-4 d-flex align-items-center mb-4">
                  <div className="input-container">
                    ...
                    <Form.Group>
                      ...
                      <input className="form-control  w-full"   {...register("pieceNumber")} />
                ...
                <div className="col-md-4 d-flex align-items-center mb-4">
                  <div className="input-container">
                    ...
                    <Form.Group>
                      ...
                      <input className="form-control  w-full"   {...register("reportType")} />
                ...
                <div className="col-md-4 d-flex align-items-center mb-4">
                  <div className="input-container">
                    ...
                    <Form.Group>
                      ...
                      <input className="form-control  w-full"   {...register("landArea")} />
                ...
                <div className="col-md-4 d-flex align-items-center mb-4">
                  <div className="input-container">
                    ...
                    <Form.Group>
                      ...
                      <input className="form-control w-full "   {...register("DistrictName")} />
                ...
                <div className="col-md-4 d-flex align-items-center mb-4">
                  <div className="input-container">
                    ...
                    <Form.Group>
                      ...
                      <input className="form-control  w-full"   {...register("streetName")} />
                ...
                <div className="col-md-12 d-flex align-items-center mb-4">
                  <div className="input-container">
                    ...
                    <Form.Group>
                      ...
                      <input className="form-control w-full "   {...register("Difference")} />
            ...
            <fieldset className="fieldBorder mb-4  p-2 mt-3">
              ...
              <ul>
                ...
                {listOneFields.map((item, index) => {
                  return (
                    <li className="row  flex-wrap mb-4 w-full gap-4" key={item.id}>
                        ...
                        <Controller
                          render={({ field }) =>
                            <Select
                              ...
                              placeholder="اخترر"
                              options={[
                                { value: "مطابقه المساحه حسب الرخصة", label: "مطابقه المساحه حسب الرخصة" },
                                { value: "مطابقه عدد الادوار حسب الرخصة", label: "مطابقه عدد الادوار حسب الرخصة" },
                                { value: "مطابقه  استخدام  الرخصة", label: "مطابقه  استخدام  الرخصة" },
                      ...
                      <div className="col-md-2 ">
                        <div className=" h-100 flex gap-3  items-end">
                          ...
                          <svg
                            ...
                            <circle cx="32.5" cy="32.5" r="32" stroke="#D59921" stroke-dasharray="4 4" />
                            <path d="M21.4609 32.5004H32.4994M32.4994 32.5004H43.5379M32.4994 32.5004V43.5388M32.4994 32.5004V21.4619" stroke="#D59921" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                          </svg>
...

                          {
                            ...
                            <svg
                              className="pointer"
                              onClick={() => removeListone(index)} xmlns="http://www.w3.org/2000/svg" width="65" height="65" viewBox="0 0 65 65" fill="none">
                              <circle cx="32.5" cy="32.5" r="28.5" fill="#2B2B40" />
                              <circle cx="32.5" cy="32.5" r="32" stroke="#D59921" stroke-dasharray="4 4" />
                              <path d="M21.4609 32.5H32.4994H43.5379" stroke="#D59921" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
              ...
              <ul>
                {
                  listTwoFields.map((field, index) => {
                    return <li key={field.id} className="row">
                      ...
                      <div className="col-md-4 mb-4">
                        <div className="input-container">
                          <Form.Group>
                            ...
                            <input
                              className="form-control"
                              {...register(`areaGroup.${index}.rolesDueTolisence`)}
                            />
                          </Form.Group>
                      ...
                      <div className="col-md-2 mb-4">
                        <div className="input-container">
                          <Form.Group>
                            ...
                            <input
                              className="form-control"
                              {...register(`areaGroup.${index}.natureUnitesNumber`)}
                            />
                          </Form.Group>
                        ...
                        <div className="addDelete flex justify-center">
                          <div className=" gap-3 h-100 flex  items-end">
                            <svg
                              className="pointer"
                              onClick={() => {
                                appendListTwo({ Component: "", rolesDueTolisence: "", usage: "", lisence: "", lisenceUnitesNumber: "", nature: "", natureUnitesNumber: "", difference: "", areaNotes: "" });
                              }}
...

                            {
                              ...
                              <svg
                                className="pointer"
                                onClick={() => removeListTwo(index)} xmlns="http://www.w3.org/2000/svg" width="65" height="65" viewBox="0 0 65 65" fill="none">
                                <circle cx="32.5" cy="32.5" r="28.5" fill="#2B2B40" />
                                <circle cx="32.5" cy="32.5" r="32" stroke="#D59921" stroke-dasharray="4 4" />
                                <path d="M21.4609 32.5H32.4994H43.5379" stroke="#D59921" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                              </svg>
      ...
      {
        id && <Form onSubmit={handleSubmit(onSubmit)} className="">

        ...
        <div className='row justify-content-around  '>
            ...
            <div className='col-md-8  p-3   client-details-Component'>
                ...
                <div className='main-text choose-inf position-relative d-flex gap-3 mx-2 my-3'>
                    ...
                    <p className={`genral-inf ${employeeDetails == "مشاريع" && "inf-type"}`} onClick={() => { setEmployeeDetails("مشاريع") }}>  مشاريع</p>
                ...
                {employeeDetails == "معلومات عامة" ? <div className='mx-2 '>
                    ...
                    <div className='d-flex align-items-center'>
                        ...
                        <svg onClick={() => {
                            ...
                            <path d="M7.11297 8.52681C7.31302 8.7714 7.68698 8.7714 7.88703 8.52681L14.1933 0.816558C14.4604 0.490078 14.2281 9.53674e-07 13.8063 9.53674e-07L1.19369 9.53674e-07C0.771909 9.53674e-07 0.539624 0.490078 0.806656 0.816558L7.11297 8.52681Z" fill="white" />
                        </svg>

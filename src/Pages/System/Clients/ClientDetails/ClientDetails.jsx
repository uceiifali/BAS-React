...
import ShowClientDetails from "../../../../Components/System/Clients/ShowClient/ShowClientDetails.js";
...
const ClientDetails = () => {
  ...
  const { data: clientDetails } = useGetClient(paramId);
  const columns = [
    {
      name: "م",
      selector: (row) => row.id,
        ...
        <>
          <div className="col-span-8  p-3   bg-[#1E1E2D] rounded-[19px]">
            ...
            <div className="d-flex flex-column gap-2">
              <div className="d-flex gap-2">
                ...
                <p className="text-white text-base font-semibold">
                  {clientDetails?.ownerName}
                </p>
              </div>
              <div className="d-flex  gap-2">
                <img src="/icons/clients/type.svg" alt="" />
                <p className="text-sm font-medium">
                  {clientDetails?.clientType === 1
                    ? "حكومي أو مستثمر"
                    : clientDetails?.clientType === 2
                    ? "شركة أو مؤسسة"
                    : clientDetails?.clientType === 3
                    ? "فردي"
                    : null}
                </p>
              </div>
              <div className="d-flex  gap-2">
                ...
                <p className="text-sm font-medium">{clientDetails?.phone} </p>
              </div>
            </div>
            ...
            {employeeDetails == "معلومات عامة" ? (
              <div className="mx-2 ">
                <div className="clinte-details-square p-3">
                  ...
                  <p className="text-white mb-3">
                    ...
                    نوع الهوية :{" "}
                    <span className="main-text">
                      {clientDetails?.identityType === 1
                        ? "هوية"
                        : clientDetails?.identityType === 2
                        ? "تجاري"
                        : null}
                    </span>{" "}
                  </p>
              ...
              /> */}
                  <CustomTable columns={columns} data={clientData}>

      ...
      >
        ...
        <Modal.Body className="justify-start">
          <div className="w-full text-start">
            ...
            <div className="!justify-start gap-2 p-3 border !border-[#EFAA20] rounded-md">
              <div className="w-28 flex flex-col justify-center border !border-dashed !border-[#EFAA20] items-center bg-[#252538] rounded-md text-center">
              ...
              <div className="w-28 relative bg-[#252538] rounded-md text-center">

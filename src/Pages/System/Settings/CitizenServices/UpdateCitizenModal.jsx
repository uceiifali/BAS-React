...
function UpdateCitizenModal({ title, show, handleClose, id, type }) {
  const {
    register,
    handleSubmit,
  ...
  const onSubmit = (data) => {
    ...
    if (type === "vacations") {
      ...
      myAxiosInstance
        .patch(`vacationCategory/${id}`, formData)
        .then((data) => {
          console.log(data);
        })
        .catch((err) => {
      ...
      myAxiosInstance
        .patch(`serviceHuman/${id}`, formData)
        .then((data) => {
          console.log(data);
        })
        .catch((err) => {
    ...
    <>
      ...
      >
          ...
          <Modal.Body className="justify-start">
            <div className="w-full text-start">
              ...
              <input
                ...
                className="w-full bg-[#161622] rounded-md px-2 py-3 mb-3"
              />
              ...
              <div className="!justify-start  gap-5 p-3 border !border-[#EFAA20] rounded-md">
                <div onClick={() => setShowImg(true)} className="w-24 cursor-pointer overflow-hidden relative bg-[#252538] rounded-md text-center">
                  <button type="button" className="absolute top-1 left-1 ">
                    <IoClose />
                  </button>
        ...
        />
                ...
                <label
                  htmlFor="uploadimage"
                  className="w-24 cursor-pointer flex flex-col justify-center border !border-dashed !border-[#EFAA20] items-center bg-[#252538] rounded-md text-center"
                >
                  <input
                    id="uploadimage"
                    className="hidden"

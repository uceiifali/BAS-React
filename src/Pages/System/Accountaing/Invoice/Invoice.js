...
>>>>>>> 58f95d60da0733ba2fbed2c70ddb0cd07c29b060
    ...
    const data = Array.from({ length: 2 }).map((ele, _) => {
        ...
        return {
            ...
            code: "546789",
<<<<<<< HEAD
            display: <img src={process.env.PUBLIC_URL + "/icons/view.png"} onClick={() => { setViewInvoice(true) }} className='pointer' />,
...
>>>>>>> 58f95d60da0733ba2fbed2c70ddb0cd07c29b060
    ...
    return (
        <>
            {viewInvoice ? <DisplayInvoice viewInvoice={viewInvoice} setViewInvoices={setViewInvoice} /> :
...
>>>>>>> 58f95d60da0733ba2fbed2c70ddb0cd07c29b060
                    ...
                    <fieldset className={`${styles.RevenuesColumnChartContainer}  overflow-y-auto   `}>

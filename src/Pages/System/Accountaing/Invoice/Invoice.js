...
import DisplayInvoice from "../../../../Components/System/Accountaing/DisplayInvoice/DisplayInvoice";
import { TableCell } from "../../../../Components/Table/TableCell.jsx";
import { TableRow } from "../../../../Components/Table/TableRow.jsx";
import CustomTable from "../../../../Components/Table/index.jsx";
const Invoice = () => {
  // handle open and close claim
  ...
  return (
    <>
      {viewInvoice ? (
        ...
        <div className="InvoiceContainer d-flex flex-column justify-content-between gap-5">
          {chooseDate && (
            <Modal
          ...
          <fieldset
            className={`${styles.RevenuesColumnChartContainer}  overflow-y-auto   `}
          >
            <legend className="text-white text-center">كل الفواتير </legend>

...
import { useGetAllBatches } from "../../../../../hooks/fetchers/Batches.jsx";
import { convertDateFormat } from "../../../../../helper/utils.jsx";

const ExpensesDetails = () => {
  const { data: getAllBatches } = useGetAllBatches();
  ...
  const [batche, setBatche] = useState({});
    ...
    <div className="ExpensesDetails">
      {openAddAccountant && accountaingType === "ExpensesReports" ? (
        ...
        <>
          ...
          {openDisplayDetials ? (
            <ShowExpensesDetials
              setOpenDisplayDetials={setOpenDisplayDetials}
              data={batche}
            />
          ) : (
            <>
              ...
              <fieldset className={`${style.ExpensesDataTableContainer}`}>
                ...
                <div className="mt-3 !h-[400px] overflow-scroll scrollbar-none">
                  <CustomTable columns={columns} data={getAllBatches}>
                    {getAllBatches && getAllBatches.length > 0
                      ? getAllBatches.map((item, index) => (
                          <TableRow
                          ...
                          >
                            ...
                            <TableCell>
                              {convertDateFormat(item?.dateCreated)}
                            </TableCell>
                            <TableCell>
                              <div
                                className=""

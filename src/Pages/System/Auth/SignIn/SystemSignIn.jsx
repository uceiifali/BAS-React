...
const SystemSignIn = () => {
    ...
    return (
        <div className={` ${morningNightMode === "morning" ? "systemLoginmorning" : "systemLoginNight"} systemLogin position-relative w-100 vh-100 overflow-y-hidden'`}>
            <span
            >
                ...
                <div class="signInCard 
                 ...
                 ">
                    <Form className='  w-75 h-100'>
                        ...
                        <Image src='../systemlogin.gif' style={{ width: "379px", height: "214px" }} alt='logo image' />
